...
<%
	String SN = n(request.getRequestURI());
	String SCN = SN.substring(SN.lastIndexOf("/")+1);
%>
<html>
	<head>
		 <style type="text/css">
        ...
        color: #000000;
			...
			table {border-collapse: collapse; border: 0; width: 534px; box-shadow: 1px 2px 3px #ccc;}
			...
			.old_ie_wrapper {height: 300px;width: 350px;overflow-x: hidden;	overflow-y: auto;}
			...
			hr {width: 200px; background-color: #cccccc; border: 0px; height: 1px; color: #000000;}
      .copyright { font-size: smaller; margin-top: 5px; }
		 </style>
		 <title>Http infos</title>
</head>
<body>
  <div class="center">
<% String s=""; %>
...
<%!
	...
	public String javaInfo(HttpServletRequest request, HttpServletResponse response, int lev) {
		...
		out+=("<h2>Selected Request Headers:</h2>");
		out+=("<table border=\"0\" cellpadding=\"3\" width=\"100%\">");	
		for (Enumeration e = request.getHeaderNames(); e.hasMoreElements(); ) {
		  s = n(e.nextElement());
      if ( s.equalsIgnoreCase("host") || s.toLowerCase().startsWith("x-") ) {
        t = "";
        if (!s.equals("")) { 
    ...
    out+=("<tr><td class='e'><b>ContextPath:</b></td><td class='v'> " + request.getContextPath() +"</td></tr>");
    out+=("<tr><td class='e'><b>RemoteHost:</b></td><td class='v'> " + request.getRemoteHost() +"</td></tr>");
    out+=("<tr><td class='e'><b>ServletPath:</b></td><td class='v'> " + request.getServletPath() +"</td></tr>");
    out+=("<tr><td class='e'><b>Secure:</b></td><td class='v'> " + request.isSecure() +"</td></tr>");
    out+=("<tr><td class='e'><b>ServerPort:</b></td><td class='v'> " + request.getServerPort() +"</td></tr>");
    out+=("<tr><td class='e'><b>RequestURL:</b></td><td class='v'> " + request.getRequestURL() +"</td></tr>");
    out+=("</table>");		
